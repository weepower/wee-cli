...
module.exports = class Service {
    ...
    init(mode = process.env.WEE_CLI_MODE) {
        ...
        // If any script entry is defined, delete the default app.js entry point
        if (
            userOptions.script
            && userOptions.script.entry
            && Object.keys(userOptions.script.entry).length
        ) {
            delete defaultOptions.script.entry;
        }
